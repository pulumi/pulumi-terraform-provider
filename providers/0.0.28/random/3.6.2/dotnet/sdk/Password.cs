...
{
    [RandomResourceType("random:index/password:Password")]
    public partial class Password : global::Pulumi.CustomResource
    {
        ...
        public Password(string name, PasswordArgs args, CustomResourceOptions? options = null)
            : base("random:index/password:Password", name, args ?? new PasswordArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private Password(string name, Input<string> id, PasswordState? state = null, CustomResourceOptions? options = null)
            : base("random:index/password:Password", name, state, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
